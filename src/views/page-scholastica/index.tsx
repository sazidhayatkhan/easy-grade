          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                id="withinMark"
                className="bg-white mt-1 w-full p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary appearance-none text-black" // added appearance-none
                value={withinMark}
            ...
            <div>
              ...
              <input
                type="text"
                id="marks"
                className="bg-white mt-1 w-full p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary text-black"
                value={marks}
